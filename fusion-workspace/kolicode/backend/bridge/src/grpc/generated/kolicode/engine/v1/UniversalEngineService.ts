...
export interface UniversalEngineServiceClient extends grpc.Client {
...
export interface UniversalEngineServiceHandlers extends grpc.UntypedServiceImplementation {
...
export interface UniversalEngineServiceDefinition extends grpc.ServiceDefinition {
