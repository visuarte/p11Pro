...
(function (g) {
  ...
  var _known = new Set([
     ...
     'icon-cursor','icon-select-box','icon-pen','icon-pencil','icon-brush',
     'icon-eraser','icon-eyedropper','icon-rectangle','icon-circle','icon-polygon',
     'icon-text','icon-move','icon-rotate','icon-scale','icon-crop',
     'icon-layers','icon-magic'
  ]);
